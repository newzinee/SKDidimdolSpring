			...
			<table class="table table-hover">
				<tr>
					...
					<td><input type="text" name="title" placeholder="책 제목"
						size="35" value="${ book.title }" required class="form-control"></td>
				</tr>
				<tr>
					<td>지은이</td>
					<td><input type="text" name="author" placeholder="지은이"
						size="35" value="${ book.author }" required class="form-control"></td>
				</tr>
				<tr>
					<td>요약</td>
					<td><input type="text" name="summary" placeholder="요약"
						size="35" value="${ book.summary }" class="form-control"></td>
				</tr>
				<tr>
					<td>쪽 수</td>
				...
				<tr>
					...
					<td><a href="getBookList.do" class="btn btn-default">취소</a></td>
				</tr>
			</table>
		</form>
	</div>
